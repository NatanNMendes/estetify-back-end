...
public class PaymentMethodCreditCard extends PaymentMethod {
    ...
    public PaymentMethodCreditCard(Integer id, Double amount, String currency, Date transactionDate, PaymentStatus status, String cardNumber, String cardholderName, Date expirationDate, String cvv, Integer installments, String cardBrand) {
